...
exports.forgotPassword = checkAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a patch request with your new password and passwordConfirm to ${resettUrl} If you did not forgot your pasword please ignore this email`;
  try {
    await sendEmail({
      email: user.email,
